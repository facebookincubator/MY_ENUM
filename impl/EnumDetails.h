...
// Input:  (A,2)           A              (A)
// Output: ((A,2))         ((A))          ((A))
#define MY_ENUM_DETAILS_OP_MAKE_TUPLE(dummy1, dummy2, ENUM) ((BOOST_PP_REMOVE_PARENS(ENUM)))

// Input:  (A, (B,2) , C)
// Output: ((A))((B,2))((C))
#define MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(...) \
  BOOST_PP_SEQ_FOR_EACH(MY_ENUM_DETAILS_OP_MAKE_TUPLE, _, BOOST_PP_TUPLE_TO_SEQ(__VA_ARGS__))
...
#define MY_ENUM_DETAILS_CSV(...)                                           \
  ...
  BOOST_PP_SEQ_FOR_EACH(                                                   \
      MY_ENUM_DETAILS_OP_COMMA_VALUE,                                      \
      _,                                                                   \
...
#define MY_ENUM_DETAILS_OP_TO_PRETTY_CASE(dummy, types, PAIR)                      \
  case BOOST_PP_TUPLE_ELEM(0, types)::BOOST_PP_TUPLE_ELEM(0, PAIR): {              \
    return BOOST_PP_STRINGIZE(BOOST_PP_TUPLE_ELEM(0, PAIR)) + std::string(" (=") + \
        std::to_string(BOOST_PP_TUPLE_ELEM(1, types)(value)) + std::string(")");   \
  }
...
#define MY_ENUM_DETAILS_COMMA_SEP_STRINGS(...)                                                     \
  BOOST_PP_STRINGIZE(                                                                              \
      BOOST_PP_TUPLE_ELEM(0, BOOST_PP_SEQ_ELEM(0, MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(__VA_ARGS__)))) \
  BOOST_PP_SEQ_FOR_EACH(                                                                           \
      MY_ENUM_DETAILS_OP_COMMA_STRING,                                                             \
      _,                                                                                           \
      BOOST_PP_SEQ_POP_FRONT(MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(__VA_ARGS__)))
...
#define MY_ENUM_DETAILS_CSV_STRING(...)                                                            \
  BOOST_PP_STRINGIZE(                                                                              \
      BOOST_PP_TUPLE_ELEM(0, BOOST_PP_SEQ_ELEM(0, MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(__VA_ARGS__)))) \
  BOOST_PP_SEQ_FOR_EACH(                                                                           \
      MY_ENUM_DETAILS_OP_COMMA_VALUE_STRING,                                                       \
      _,                                                                                           \
      BOOST_PP_SEQ_POP_FRONT(MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(__VA_ARGS__)))

// Output: , ${TYPES}[1](${TYPES}[0]::${PAIR}[0])
#define MY_ENUM_DETAILS_OP_INTS(dummy, TYPES, PAIR) \
  , BOOST_PP_TUPLE_ELEM(1, TYPES)(BOOST_PP_TUPLE_ELEM(0, TYPES)::BOOST_PP_TUPLE_ELEM(0, PAIR))
...
#define MY_ENUM_DETAILS_COMMA_SEP_INTS(TYPE, INT_TYPE, ...)                    \
  ...
  BOOST_PP_SEQ_FOR_EACH(                                                       \
      MY_ENUM_DETAILS_OP_INTS,                                                 \
      (TYPE, INT_TYPE),                                                        \
      BOOST_PP_SEQ_POP_FRONT(MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(__VA_ARGS__)))

#define MY_ENUM_DEF_IMPL(EnumName, ...)                                                        \
  namespace enum_wrapper_ {                                                                    \
  enum class EnumName##Impl : MY_ENUM_DETAILS_GET_INT_TYPE(__VA_ARGS__){                       \
      MY_ENUM_DETAILS_CSV(MY_ENUM_DETAILS_GET_VARS(__VA_ARGS__))};                             \
                                                                                               \
  MY_ENUM_MAYBE_UNUSED inline std::string toString(EnumName##Impl value) {                     \
    switch (value) {                                                                           \
      BOOST_PP_SEQ_FOR_EACH(                                                                   \
          MY_ENUM_DETAILS_OP_TO_STRING_CASE,                                                   \
          EnumName##Impl,                                                                      \
          MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(MY_ENUM_DETAILS_GET_VARS(__VA_ARGS__)))             \
    }                                                                                          \
    MY_ENUM_ABORT(                                                                             \
        BOOST_PP_STRINGIZE(EnumName) " does contain invalid value: {}",                        \
        MY_ENUM_DETAILS_GET_INT_TYPE(__VA_ARGS__)(value));                                     \
  }                                                                                            \
                                                                                               \
  MY_ENUM_MAYBE_UNUSED inline fmt::string_view toStringView(EnumName##Impl value) {            \
    switch (value) {                                                                           \
      BOOST_PP_SEQ_FOR_EACH(                                                                   \
          MY_ENUM_DETAILS_OP_TO_STRING_CASE,                                                   \
          EnumName##Impl,                                                                      \
    ...
    MY_ENUM_ABORT(                                                                             \
        ...
        MY_ENUM_DETAILS_GET_INT_TYPE(__VA_ARGS__)(value));                                     \
                                                                                               ...
                                                                                               \
  MY_ENUM_MAYBE_UNUSED inline std::string toPretty(EnumName##Impl value) {                     \
    switch (value) {                                                                           \
      BOOST_PP_SEQ_FOR_EACH(                                                                   \
          MY_ENUM_DETAILS_OP_TO_PRETTY_CASE,                                                   \
          (EnumName##Impl, MY_ENUM_DETAILS_GET_INT_TYPE(__VA_ARGS__)),                         \
          MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(MY_ENUM_DETAILS_GET_VARS(__VA_ARGS__)))             \
    }                                                                                          \
    MY_ENUM_ABORT(                                                                             \
        BOOST_PP_STRINGIZE(EnumName) " does contain invalid value: {}",                        \
  ...
  MY_ENUM_MAYBE_UNUSED MY_ENUM_NODISCARD inline bool trySetFromString(                         \
    ...
    BOOST_PP_SEQ_FOR_EACH(                                                                     \
        MY_ENUM_DETAILS_OP_SET_VALUE_CASES,                                                    \
        EnumName##Impl,                                                                        \
        MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(MY_ENUM_DETAILS_GET_VARS(__VA_ARGS__)))               \
    return false;                                                                              \
  }                                                                                            \
                                                                                               \
  MY_ENUM_MAYBE_UNUSED MY_ENUM_NODISCARD constexpr size_t getCount(EnumName##Impl) {           \
    return BOOST_PP_TUPLE_SIZE(MY_ENUM_DETAILS_GET_VARS(__VA_ARGS__));                         \
  }                                                                                            \
                                                                                               \
  MY_ENUM_MAYBE_UNUSED                                                                         \
  MY_ENUM_NODISCARD inline std::                                                               \
      array<fmt::string_view, BOOST_PP_TUPLE_SIZE(MY_ENUM_DETAILS_GET_VARS(__VA_ARGS__))>      \
      getStrings(EnumName##Impl) {                                                             \
    return {MY_ENUM_DETAILS_COMMA_SEP_STRINGS(MY_ENUM_DETAILS_GET_VARS(__VA_ARGS__))};         \
  }                                                                                            \
                                                                                               \
  MY_ENUM_MAYBE_UNUSED MY_ENUM_NODISCARD inline fmt::string_view getStringOfStrings(           \
      EnumName##Impl) {                                                                        \
  ...
  getValues(EnumName##Impl) {                                                                  \
    return {MY_ENUM_DETAILS_COMMA_SEP_INTS(                                                    \
        ...
        MY_ENUM_DETAILS_GET_VARS(__VA_ARGS__))};                                               \
                                                                                               ...
                                                                                               \
  MY_ENUM_MAYBE_UNUSED MY_ENUM_NODISCARD constexpr size_t getPosition(EnumName##Impl value) {  \
    switch (value) {                                                                           \
      BOOST_PP_SEQ_FOR_EACH_I(                                                                 \
          MY_ENUM_DETAILS_OP_POSITION_ICASE,                                                   \
          EnumName##Impl,                                                                      \
          MY_ENUM_DETAILS_TO_SEQ_OF_TUPLES(MY_ENUM_DETAILS_GET_VARS(__VA_ARGS__)))             \
    }                                                                                          \
    MY_ENUM_ABORT(                                                                             \
        ...
        MY_ENUM_DETAILS_GET_INT_TYPE(__VA_ARGS__)(value));                                     \
                                                                                               ...
                                                                                               \
  MY_ENUM_MAYBE_UNUSED MY_ENUM_NODISCARD inline fmt::string_view getTypeName(EnumName##Impl) { \
    return BOOST_PP_STRINGIZE(EnumName);                                                       \
  }                                                                                            \
  } // namespace enum_wrapper_
